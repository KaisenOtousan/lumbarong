          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="md:col-span-1 space-y-6">
              <div className="artisan-card p-10 flex flex-col items-center text-center group hover:scale-[1.02] transition-all shadow-2xl relative overflow-hidden bg-white">
                ...
                <div className="w-24 h-24 bg-[var(--bark)] rounded-3xl flex items-center justify-center text-white font-serif text-4xl font-bold shadow-2xl ring-4 ring-white group-hover:rotate-6 transition-transform overflow-hidden">
                  {user.profilePhoto ? (
            ...
            <div className="md:col-span-2 space-y-8 animate-fade-in">
              <div className="artisan-card p-12 space-y-10 shadow-2xl bg-white/50 backdrop-blur-md">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                  ...
                  <ProfileItem label="Contact Number" value={user.mobile || '+63 9xx xxx xxxx'} icon={<Phone />} />
                  {/* Clickable Location */}
                ...
                <div className="pt-10 border-t border-[var(--border)] grid grid-cols-1 sm:grid-cols-2 gap-10">
                  ...
                  <ProfileItem 
                    ...
                    value={user.indigencyCertificate ? "Active Support Level" : "Basic Artisan"} 
                    icon={<Building />} 
                  />
                </div>
                ...
                <div className="pt-10 border-t border-[var(--border)] grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-lg font-serif font-bold text-[var(--charcoal)] tracking-tight">
                      {user.gcashNumber || '09XX-XXX-XXXX'}
                    </div>
                    {user.gcashQrCode ? (
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input type="text" value={formData.mayaNumber} onChange={e => setFormData({ ...formData, mayaNumber: e.target.value })} className="w-full p-4 border border-[var(--border)] rounded-xl bg-[var(--input-bg)] text-sm text-[var(--charcoal)] focus:outline-none focus:border-[var(--rust)] focus:ring-1 focus:ring-[var(--rust)]" />
                </div>
                <div className="space-y-2">
            ...
            >
              <div className="p-10">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h2 className="font-serif text-3xl font-bold text-[var(--charcoal)] tracking-tight uppercase">
                ...
                <form onSubmit={handleSaveLocation} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-[var(--muted)] uppercase tracking-widest flex items-center gap-2"><Home className="w-3.5 h-3.5" /> House No. / Building</label>
